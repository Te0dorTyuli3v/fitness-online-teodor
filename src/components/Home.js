...
function Home() {
  ...
  return (
    <div>
      <h2>Добре дошли във "My Progress Guru"</h2>
      <p>My Progress Guru е приложение, което ви помага да следите и организирате тренировките си, като предоставя персонализирани тренировъчни планове и прогрес.</p>
